...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        ctystr = cty.__str__()
        self.assertIn("[City] (123456789)", ctystr)
        self.assertIn("'id': '123456789'", ctystr)
        self.assertIn("'created_at': " + dtime_repr, ctystr)
        self.assertIn("'updated_at': " + dtime_repr, ctystr)
